			...
			return layout.Inset{
				...
				return layout.Stack{}.Layout(gtx,
					layout.Stacked(func(gtx layout.Context) layout.Dimensions {
						btn := material.Button(th, &store.StatusBackground, "Wallpaper temporarly disabled , preloading is needed")
				...
				return layout.Flex{
					...
					layout.Flexed(0.5, func(gtx layout.Context) layout.Dimensions {
						return layout.Inset{
							...
							btn := material.Button(th, &store.StatusBackground, "00:00")
							btn.TextSize = unit.Sp(25)
							return btn.Layout(gtx)
						})
					}),
					layout.Flexed(0.3, func(gtx layout.Context) layout.Dimensions {
						return material.Button(th, &store.StatusBackground, "start Timer").Layout(gtx)
					}),
				)
			})
		}),
